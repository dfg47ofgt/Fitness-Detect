!function() {
  ...
  Calendar.prototype.drawHeader = function() {
    ...
    var thismonth =this.current.format("MMM");
    if (this.current.format("MMM") == "Jan"){
      var thismonth ='1月';
    }else if (this.current.format("MMM")== "Feb"){
      var thismonth ='2月';
    }else if (this.current.format("MMM")== "Mar"){
      var thismonth ='3月';
    }else if (this.current.format("MMM")== "Apr"){
      var thismonth ='4月';
    }else if (this.current.format("MMM")== "May"){
      var thismonth ='5月';
    }else if (this.current.format("MMM")== "Jun"){
      var thismonth ='6月';
    }else if (this.current.format("MMM")== "Jul"){
      var thismonth ='7月';
    }else if (this.current.format("MMM")== "Aug"){
      var thismonth ='8月';
    }else if (this.current.format("MMM")== "Sep"){
      var thismonth ='9月';
    }else if (this.current.format("MMM")== "Oct"){
      var thismonth ='10月';
    }else if (this.current.format("MMM")== "Nov"){
      var thismonth ='11月';
    }else if (this.current.format("MMM")== "Dec"){
      var thismonth ='12月';
    }

    this.title.innerHTML = this.current.format('YYYY') +"年  "+ thismonth;
  }
  ...
  Calendar.prototype.drawDay = function(day) {
    ...
    if (day.format('ddd') == "Mon"){
      ...
      var thisday ='週 六';
    }else if (day.format('ddd') == "Sun"){
      var thisday ='週 日';
    }

    var name = createElement('div', 'day-name', thisday);
      ...
      <div class="alert-frame">
        ...
        <div class="alert-body">
          ...
          <video class="alert-video" muted controls>
            <source src="../video/${userid}/${date}.mp4" type="video/mp4" alt="${date}">  
            //路徑放在這裡
            </video>
