...
def gaming_1_make_circle(img,position,cir_sum,field_left,field_right,point_position,point_field_left,point_field_right,point_time):
    p_Time = time.time()+ 4
        ...
        if len(lmList) != 0:
            if set_count <= 50:
                ...
                if len(point_position) < circle_count:
                    ...
                    point_position,point_field_left,point_field_right,point_time = gaming_1_make_circle(img,position,\
